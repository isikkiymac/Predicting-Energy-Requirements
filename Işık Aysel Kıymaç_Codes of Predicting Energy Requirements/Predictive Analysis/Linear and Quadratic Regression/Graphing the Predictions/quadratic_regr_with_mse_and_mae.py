...
#data from CSV files
data1 = pd.read_csv('quadratic_regression_analysis - Sheet1.csv') 
...
plt.plot(x1, y1, label='Quadratic Regression')
...
plt.title('Comparison of Hourly Energy Consumption and Predicted Energy Consumption by Quadratic Regression')
